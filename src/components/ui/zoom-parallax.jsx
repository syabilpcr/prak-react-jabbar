...
/**
 * ZoomParallax — Animasi perbesaran gambar bertumpuk dengan efek paralaks scroll.
 * 
 * Props:
 * - images: array objek berisi { src, alt } (maks 7 gambar)
 */
export function ZoomParallax({ images }) {
	...
	return (
		<div ref={container} className="relative h-[300vh] bg-[#0b0b0d]">
