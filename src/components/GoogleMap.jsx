...
const GoogleMap = () => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E8C999]/50 overflow-hidden">
      <div className="px-5 py-3.5 border-b border-[#E8C999]/50 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <MapPin size={15} className="text-[#8E1616]" />
